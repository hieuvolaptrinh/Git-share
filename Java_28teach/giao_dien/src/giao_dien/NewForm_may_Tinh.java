 ...
 * @author hieuvo
 */
public class NewForm_may_Tinh extends javax.swing.JFrame {

    /**
     * Creates new form NewForm
     */
    public NewForm_may_Tinh() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewForm_may_Tinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewForm_may_Tinh().setVisible(true);
            }
        });
    }
